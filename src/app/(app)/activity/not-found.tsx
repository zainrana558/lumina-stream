  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(100,149,237,.15) 0%, rgba(255,179,71,.15) 100%)',
        display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2rem',
        boxShadow: '8px 8px 24px rgba(0,0,0,.82), -4px -4px 11px rgba(45,25,90,.28)',
      }} aria-hidden="true"><Smartphone size={32} color="currentColor" /></div>
      ...
      <p className="f-crimson" style={{ color: 'rgba(255,245,232,.5)', fontSize: '.95rem', maxWidth: 360, textAlign: 'center', lineHeight: 1.7 }}>
        This activity page doesn't exist.
      </p>
      <div style={{ display: 'flex', gap: '.85rem' }}>
        <button onClick={() => router.push('/activity')} className="btn-p">Activity Feed</button>
