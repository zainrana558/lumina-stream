  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(60px,7vw,80px) 20px 60px' }}>
        ...
        <p {...ps}>
          By accessing, browsing, or using Lumovia (the &quot;Service,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service (&quot;Terms&quot;), our <Link href="/privacy" style={{ color: '#FFB347' }}>Privacy Policy</Link>, our <Link href="/cookies" style={{ color: '#FFB347' }}>Cookie Policy</Link>, our <Link href="/disclaimer" style={{ color: '#FFB347' }}>Disclaimer</Link>, and our <Link href="/dmca" style={{ color: '#FFB347' }}>DMCA &amp; Copyright Policy</Link>, all of which are incorporated herein by reference and collectively referred to as the &quot;Agreement.&quot; If you do not agree with any part of this Agreement, you must discontinue use of the Service immediately and cease all access to the website. These Terms constitute a legally binding agreement between you (&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;) and Lumovia. We reserve the right to refuse service to anyone for any reason at any time without notice. Your continued use of the Service following the posting of any changes to these Terms constitutes your informed acceptance of those changes, whether or not you received direct notification.
        </p>

        {/* ── 2. Nature of the Service ── */}
        <h2 {...h2}>2. Nature of the Service</h2>
        <p {...p}>
          <strong {...b}>2.1 Catalog and Discovery Platform.</strong> Lumovia is a free, non-commercial catalog and discovery platform designed to help users explore, organize, and track information about movies, TV shows, and anime. The Service aggregates metadata from publicly available, authorized sources, including The Movie Database (TMDB) and AniList, to present rich informational content such as synopses, cast and crew details, ratings, release schedules, and posters. <strong {...b}>Lumovia does not host, upload, store, cache, transcode, distribute, or stream any video or audio files on its servers or infrastructure.</strong>
        </p>
        <p {...p}>
          <strong {...b}>2.2 Third-Party Embed Functionality.</strong> The Service may provide embedded streaming players that link to content hosted on third-party websites operated by independent entities entirely unaffiliated with Lumovia. When a user elects to use an embedded player, the user is accessing content from that third-party provider&apos;s own servers and infrastructure. Lumovia serves solely as an informational directory and does not control, operate, endorse, or assume responsibility for any third-party streaming provider, its content, its legality, or its availability. The inclusion of any embedded player does not constitute an endorsement, partnership, or affiliation of any kind with the respective third-party provider.
        </p>
        <p {...p}>
          <strong {...b}>2.3 No Content Hosting.</strong> At no point does any video, audio, or audiovisual content pass through, reside on, or originate from Lumovia&apos;s servers. We do not operate any media servers, CDN nodes, or content delivery infrastructure for streaming media. Our servers serve only HTML, CSS, JavaScript, API responses containing metadata, and static assets (images, fonts, icons). Any streaming that occurs happens exclusively between the user&apos;s browser and the third-party provider&apos;s servers.
        </p>
        <p {...ps}>
          <strong {...b}>2.4 Search Engine / Directory Function.</strong> Lumovia functions as a specialized search engine and informational directory, similar in nature to how general-purpose search engines index and link to third-party content across the internet. The Service provides hypertext links and embeds to content that exists elsewhere on the internet. The provision of links or embeds to third-party content does not constitute hosting, distribution, or publication of that content by Lumovia.
        </p>
        ...
        <p {...p}>
          <strong {...b}>4.2 Account Security.</strong> You are solely responsible for maintaining the confidentiality of your account credentials, including your password and authentication tokens. You must notify us immediately of any unauthorized use of your account or any other breach of security. Lumovia will not be liable for any loss or damage arising from your failure to protect your account information. You agree not to share your account credentials with any third party.
        </p>
        <p {...p}>
        ...
        <p {...p}>
          <strong {...b}>6.1 Service Ownership.</strong> The Lumovia website, including its design, layout, code, graphics, logos, and original content (excluding third-party metadata), is the intellectual property of Lumovia and is protected by applicable copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, modify, create derivative works from, or commercially exploit any part of the Service without our prior written permission.
        </p>
        <p {...p}>
        ...
        <p {...p}>
          <strong {...b}>9.3 No Financial Benefit from Infringement.</strong> Lumovia does not receive a direct financial benefit from any specific act of infringement that is identifiable on our Service. The Service is provided free of charge to users and any advertising revenue is not attributable to the availability of any specific third-party content.
        </p>
        <p {...ps}>
        ...
        <p {...ps}>
          The failure of Lumovia to enforce any right or provision of these Terms at any time shall not constitute a waiver of such right or provision. Any waiver of any provision of these Terms will be effective only if in writing and signed by Lumovia. A waiver of any breach of these Terms shall not be deemed a waiver of any subsequent or similar breach. No course of dealing, course of performance, or trade usage shall be used to modify, explain, or supplement any provision of these Terms. Lumovia&apos;s rights and remedies under these Terms are cumulative and not exclusive of any other rights or remedies available at law or in equity.
        </p>

        {/* ── 16. Entire Agreement ── */}
        <h2 {...h2}>16. Entire Agreement</h2>
        <p {...ps}>
          These Terms, together with the <Link href="/privacy" style={{ color: '#FFB347' }}>Privacy Policy</Link>, <Link href="/cookies" style={{ color: '#FFB347' }}>Cookie Policy</Link>, <Link href="/disclaimer" style={{ color: '#FFB347' }}>Disclaimer</Link>, and <Link href="/dmca" style={{ color: '#FFB347' }}>DMCA &amp; Copyright Policy</Link>, constitute the entire agreement between you and Lumovia regarding the Service and supersede all prior or contemporaneous communications, representations, agreements, understandings, and negotiations, whether oral or written, between you and Lumovia relating to the Service. No modification of these Terms shall be effective unless made in accordance with Section 17 below.
        </p>
        ...
        <p {...p}>
          <strong {...b}>18.3 Class Action Waiver.</strong> You agree that any dispute resolution proceedings will be conducted only on an individual basis and not in a class, consolidated, or representative action. You waive any right to participate in a class action lawsuit or class-wide arbitration against Lumovia. If for any reason a claim proceeds in court rather than in arbitration, you and Lumovia each waive any right to a jury trial.
        </p>
        <p {...ps}>
        ...
        <p {...p}>
          <strong {...b}>19.2 By Lumovia.</strong> We may suspend or terminate your access to the Service at any time, with or without cause, and with or without notice. We may also discontinue or modify the Service at any time without liability to you.
        </p>
        <p {...ps}>
