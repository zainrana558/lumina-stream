  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(60px,7vw,80px) 20px 60px' }}>
        ...
        <h2 {...h2}>4. Embedded Player Behavior and Pop-Ups</h2>
        <p {...ps}>
          Embedded players are, by default, loaded inside a restricted browser sandbox that blocks pop-ups and prevents the embed from redirecting your browser tab away from the Service. <strong {...b}>A small number of lower-priority, clearly-marked third-party sources will not play video at all under that restriction</strong> and require it to be relaxed for playback to function; we only do so for those specific sources, and an on-screen warning is displayed for as long as one is active. Relaxing this restriction means such a source could, in principle, attempt to open an additional tab, window, or page. <strong {...b}>If a tab or page opens unexpectedly while using the Service, do not trust it and do not enter any information into it</strong> — simply close it and return to Lumovia. This does not affect your Lumovia account, session, or any data stored with us; it is a property of the specific third-party embed you selected, not of Lumovia itself. Choosing a different source from the player&apos;s selector avoids this category of provider entirely.
        </p>

        <h2 {...h2}>5. User Responsibility for Lawful Use</h2>
        <p {...ps}>
        ...
        <h2 {...h2}>6. No Warranty of Content Legality</h2>
        <p {...ps}>
        ...
        <h2 {...h2}>7. Accuracy of Metadata</h2>
        <p {...ps}>
        ...
        <h2 {...h2}>9. No Professional Advice</h2>
        <p {...ps}>
        ...
        <h2 {...h2}>10. Limitation of Liability</h2>
        <p {...ps}>
        ...
        <h2 {...h2}>11. Changes to This Disclaimer</h2>
        <p {...ps}>
