...
export default function GenresError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', maxWidth: 480, padding: '2rem' }}>
        ...
        }}><Drama size={32} color="currentColor" /></div>
        ...
        <p className="f-crimson" style={{ color: 'rgba(255,245,232,.5)', fontSize: '1rem', lineHeight: 1.7, marginBottom: '1.5rem' }}>
          We couldn&apos;t load the genre catalog. Please try again.
        </p>
