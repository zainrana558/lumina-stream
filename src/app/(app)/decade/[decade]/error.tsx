...
export default function DecadeError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div style={{
      ...
      <p className="f-crimson" style={{ color: 'rgba(255,245,232,.55)', fontSize: 'clamp(.88rem,1.1vw,1rem)', lineHeight: 1.7, maxWidth: 400, textAlign: 'center' }}>
        Could not fetch content for this decade. Please try again.
      </p>
