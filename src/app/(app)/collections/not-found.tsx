...
export default function NotFound() {
  ...
  return (
    <div style={{
      ...
      }} aria-hidden="true"><BookOpen size={32} color="currentColor" /></div>
      <h2 className="f-cinzel" style={{ color: 'rgba(255,245,232,.8)', letterSpacing: '.08em', fontSize: '1.2rem' }}>Collection not found</h2>
      ...
      <div style={{ display: 'flex', gap: '.85rem' }}>
        <button onClick={() => router.push('/collections')} className="btn-p">My Collections</button>
