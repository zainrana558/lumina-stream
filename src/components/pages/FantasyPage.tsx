...
export default function FantasyPage({ initialShows }: { initialShows: MediaItem[] }) {
  ...
  return (
    <div className="page" style={{
        ...
        <GenreNavTheme acc={PORTAL_GENRE_MAP.fantasy.tc} acc2={PORTAL_GENRE_MAP.fantasy.tc2} />

        {/* Hero backdrop — top result's own image, dissolving into the page */}
        {heroBackdrop && (
          <div style={{
            position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none',
            backgroundImage: `linear-gradient(180deg, rgba(13,5,32,.4) 0%, rgba(13,5,32,.8) 55%, #0D0520 100%), url(${heroBackdrop})`,
        ...
        <Suspense fallback={null}><GenreParticles genre="fantasy" /></Suspense>
