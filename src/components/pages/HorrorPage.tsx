...
export default function HorrorPage({ initialShows }: { initialShows: MediaItem[] }) {
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/tmdb?endpoint=/discover/movie&with_genres=27&sort_by=popularity.desc&vote_count.gte=50&page=${nextPage}`);
  ...
  return (
    <div className="page" style={{
        ...
        <Suspense fallback={null}><GenreParticles genre="horror" /></Suspense>
